...
cursor.execute("CREATE TABLE IF NOT EXISTS users (idActivity INT PRIMARY KEY NOT NULL AUTOINCREMENT, Activity VARCHAR(255), Time INT, FOREIGN KEY (username) REFERENCES users(username))")
